...
const page = () => {
 ...
 <Input type={'text'} label={'المستودع'} name={'store'}/>
    ...
    <button className="flex-shrink-0 relative  right-3 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
        ارسال البيانات
      </button>
