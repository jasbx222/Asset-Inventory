...
export default function Page() {
  return (
    <div className="min-h-screen container w-[100%] bg-gray-50 p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-rows-2 gap-6 max-w-4xl mx-auto">
        {/* إضافة اصل */}
        <div className="bg-gray-400 rounded-2xl shadow-md p-6 hover:shadow-lg transition cursor-pointer text-center">
        ...
        {/* تحويل الاصل */}
        <div className="bg-gray-400 rounded-2xl shadow-md p-6 hover:shadow-lg transition cursor-pointer text-center col-span-1 sm:col-span-2 flex flex-col items-center justify-center gap-2">
